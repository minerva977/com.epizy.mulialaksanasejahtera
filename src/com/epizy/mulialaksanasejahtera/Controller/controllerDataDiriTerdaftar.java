...
import com.epizy.mulialaksanasejahtera.DAO.dataDiriTerdaftarDAO;
import com.epizy.mulialaksanasejahtera.DAOImpl.dataDiriTerdaftarDAOImpl;
import com.epizy.mulialaksanasejahtera.Model.dataDiriTerdaftar;
import com.epizy.mulialaksanasejahtera.TabelModel.tabelModelDataDiriTerdaftar;

import javax.swing.*;
import java.util.List;

public class controllerDataDiriTerdaftar {
    JFrame jFrame;
    JInternalFrame jInternalFrame;
    final dataDiriTerdaftarDAO dataDiriDAO;
    List<dataDiriTerdaftar> dataDiriList;

// --Commented out by Inspection START (25/11/2017 12.44.33 PM):
//    public controllerDataDiriTerdaftar(JFrame jFrames) {
//        this.jFrame = jFrames;
//        dataDiriDAO = new dataDiriTerdaftarDAOImpl();
//        dataDiriList = dataDiriDAO.GetAll();
//    }
// --Commented out by Inspection STOP (25/11/2017 12.44.33 PM)
    public controllerDataDiriTerdaftar(JInternalFrame jInternalFrame) {
    ...
    public void setTabel(JTable jTable) {
        dataDiriList = dataDiriDAO.GetAll();
        tabelModelDataDiriTerdaftar tabelModelDataDiri = new tabelModelDataDiriTerdaftar(dataDiriList);
...
//        dataDiriTerdaftar dataDiri = new dataDiriTerdaftar();
